...
def summarize_xlingual(
    ...
    if os.path.isfile(os.path.join(output_dir, f"{args.data_type}_generations.txt")):
        path=os.path.join(output_dir, f"{args.data_type}_generations.txt")
        print("os.path.isfile= ",path)
        return
    if os.path.isfile(os.path.join(output_dir, f"test_generations.txt")):
        path=os.path.join(output_dir, f"test_generations.txt")
        print("os.path.isfile= ",path)
        return


    script_path =  os.path.abspath("pipeline_eval.py")
    script_args = [
